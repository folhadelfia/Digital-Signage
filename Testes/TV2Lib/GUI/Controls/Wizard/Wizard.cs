...
namespace CristiPotlog.Controls
{
	...
	public class Wizard : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonBack.Font = null;
			this.buttonBack.Name = "buttonBack";
			this.buttonBack.Click += new System.EventHandler(this.buttonBack_Click);
			// 
			// buttonHelp
			// 
			this.buttonHelp.AccessibleDescription = null;
			this.buttonHelp.AccessibleName = null;
			resources.ApplyResources(this.buttonHelp, "buttonHelp");
			this.buttonHelp.BackgroundImage = null;
			this.buttonHelp.Font = null;
		...
		private void ActivatePage(WizardPage page)
		{
			...
			if (this.selectedPage != null)
			{
				...
				{
					this.buttonCancel.Text = CodeTV.Properties.Resources.OK; //"OK";
					this.buttonCancel.DialogResult = DialogResult.OK;
				}
				else
				{
					this.buttonCancel.Text = CodeTV.Properties.Resources.Cancel; //"Cancel";
