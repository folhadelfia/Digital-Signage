...
namespace TV2Lib
{
	public class GraphBuilderTV : GraphBuilderBase, ITV
    {
		...
		public Channel CurrentChannel { get { return this.currentChannel ?? (this.currentChannel = new ChannelDVBT()); } set { this.currentChannel = value; } } //Deus queira que não seja preciso mudar para satélite
