    ...
    public static class NetWCFConverter
    {
        ...
        public static WCFItemConfiguration ToWCF(ItemConfiguration item)
        {
            if (item is MarkeeConfiguration)
            {
                ...
                return new WCFMarkeeConfiguration()
                {
        ...
        {
            if (item is WCFMarkeeConfiguration)
            {
                var footer = item as WCFMarkeeConfiguration;
            ...
            else if (item is WCFVideoConfiguration)
            {
                var videoConfig = item as WCFVideoConfiguration;
